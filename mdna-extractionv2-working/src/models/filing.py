"""Data models for SEC filings and extraction results - ORIGINAL VERSION."""
...
@dataclass
class Filing:
    """Represents a 10-K or 10-K/A filing - ORIGINAL VERSION."""
    cik: str
    company_name: str
...
class ExtractionResult:
    """Results from MD&A extraction - ORIGINAL VERSION."""
    filing: Filing
    mdna_text: str
